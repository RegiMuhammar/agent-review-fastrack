...
CONTEXT_INSTRUCTIONS = {
    ...
    "research": (
        ...
        "- Evaluasi NOVELTY berdasarkan kebaruan dibanding referensi yang tersedia\n"
        "- Evaluasi PRIOR WORK dengan melihat apakah paper menyitasi/membahas literatur yang cukup\n"
